...
// Escenarios mock:
//   A1522-0847  → OK (encontrado, listo para facturar)
//   A1522-1203  → alreadyInvoiced (ya tiene CFDI emitido)
//   A1522-9999  → notfound (folio inexistente — basta con teclearlo manualmente)
//   A1522-0847 con total ≠ 2499  → mismatch (captura un importe distinto para verlo)
export const DEMO_TICKETS: Record<string, Ticket> = {
  ...
  // Escenario "mismatch": ticket encontrado pero el importe demo no coincide (total real: 3250)
  'A1522-5501': {
