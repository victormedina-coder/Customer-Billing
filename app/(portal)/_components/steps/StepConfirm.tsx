    ...
    <div style={{ width: '100%', maxWidth: 520, animation: 'fadeIn 0.3s ease both' }}>
      ...
      <div style={CARD}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
          <div style={{ fontSize: 13.5, fontWeight: 800, color: '#1a1a1a', display: 'flex', alignItems: 'center', gap: 8 }}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#108474" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div style={CARD}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 14 }}>
          <div style={{ background: '#f5f8f7', borderRadius: 10, padding: '10px 12px' }}>
        ...
        {/* Totals */}
        <div style={{ borderTop: '1px solid #e2e7e6', paddingTop: 14 }}>
