...
import { TerminosCondicionesContent } from '../(portal)/_components/legal/TerminosCondicionesContent'
import { BackButton } from '../aviso-privacidad/BackButton'

export const metadata: Metadata = {
  title: 'Términos y Condiciones | Grupo Quince 22',
  description:
    'Términos y Condiciones de uso del portal de facturación de Grupo Quince 22, S.A. de C.V.',
}
...
export default function TerminosCondicionesPage(): React.ReactElement {
  return (
